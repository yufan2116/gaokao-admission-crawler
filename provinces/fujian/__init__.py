...
from provinces.fujian import config


def _is_fj_detail_url(url: str) -> bool:
    path = urlparse(url).path.lower()
    return "/gkptgkgsgg/" in path and (path.endswith(".html") or path.endswith(".jhtml"))


class FujianPlugin(ProvincePlugin):
    ...
    is_detail_page_url = staticmethod(_is_fj_detail_url)
