...
from provinces.zhejiang import config


def _is_zj_detail_url(url: str) -> bool:
    path = urlparse(url).path
    return "/art/" in path and path.endswith(".html")


class ZhejiangPlugin(ProvincePlugin):
    ...
    is_detail_page_url = staticmethod(_is_zj_detail_url)
